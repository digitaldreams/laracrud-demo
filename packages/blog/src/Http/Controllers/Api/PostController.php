...
use Blog\Http\Requests\Api\Posts\Index;
use Blog\Http\Requests\Api\Posts\Show;
use Blog\Http\Requests\Api\Posts\Store;
use Blog\Http\Requests\Api\Posts\Update;
use Blog\Http\Requests\Api\Posts\Destroy;
...
class PostController extends ApiController
{
     ...
     *           "data": {{}}
     *         }),
     *      @Response(404, body={"message": "No query results for model [Blog\Models\Post]."})
     * })
     */
