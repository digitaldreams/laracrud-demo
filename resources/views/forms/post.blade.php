<form action="{{$route or route('posts.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" id="slug"
               value="{{old('slug',$model->slug)}}" placeholder="" maxlength="255">
        @if($errors->has('slug'))
            <div class="invalid-feedback">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('body') ? ' is-invalid' : '' }}" name="body" id="body"
               value="{{old('body',$model->body)}}" placeholder="">
        @if($errors->has('body'))
            <div class="invalid-feedback">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="datetime" class="form-control {{ $errors->has('published_at') ? ' is-invalid' : '' }}"
